[Skip to main content](https://docs.mistral.ai/guides/prompting_capabilities/#__docusaurus_skipToContent_fallback)
[![Mistral AI Logo](https://docs.mistral.ai/img/logo.svg)](https://mistral.ai/)[Le Chat](https://chat.mistral.ai/)[La Plateforme](https://console.mistral.ai/)[Docs](https://docs.mistral.ai/)[API](https://docs.mistral.ai/api/)
[GitHub](https://github.com/mistralai/)[Discord](https://discord.gg/mistralai)
  ...
  * [OCR and Document Understanding](https://docs.mistral.ai/capabilities/document/)
  ...
  * [Citations and References](https://docs.mistral.ai/capabilities/citations/)
  * [Structured Output](https://docs.mistral.ai/capabilities/structured-output/structured_output_overview/)
  * [Moderation](https://docs.mistral.ai/capabilities/guardrailing/)
  * [Finetuning](https://docs.mistral.ai/capabilities/finetuning/finetuning_overview/)
  * [Agents](https://docs.mistral.ai/capabilities/agents/)
  * [Batch Inference](https://docs.mistral.ai/capabilities/batch/)
  * [Predicted outputs](https://docs.mistral.ai/capabilities/predicted-outputs/)
  * Deployment
  * [La Plateforme](https://docs.mistral.ai/deployment/laplateforme/overview/)
  * [Cloud](https://docs.mistral.ai/deployment/cloud/overview/)
  * [Self-deployment](https://docs.mistral.ai/deployment/self-deployment/overview/)
  * Guides
...
#### Strategies we used:[​](https://docs.mistral.ai/guides/prompting_capabilities/#strategies-we-used-2 "Direct link to Strategies we used:")
